...
class PlayerCamera {
    ...
    void logCamera() {
        std::cout << "Position is : " << this->camera.position.x << " " << this->camera.position.y << " " << this->camera.position.z << std::endl;
        std::cout << "Target is : " << this->camera.target.x << " " << this->camera.target.y << " " << this->camera.target.z << std::endl;
    }
